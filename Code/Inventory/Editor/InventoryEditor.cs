...
namespace InventoryPlus
{
    ...
    public class InventoryEditor : Editor
    {
        ...
        public SerializedProperty _prefabUISlot;
        public SerializedProperty _inventoryUISlotsContainer;
        ...
        public SerializedProperty _pickupContext;
        public SerializedProperty _swapUIZone;
        ...
        {
            _prefabUISlot = serializedObject.FindProperty("prefabUISlot");
            _inventoryUISlotsContainer = serializedObject.FindProperty("inventoryUISlotsContainer");
            ...
            _pickupContext = serializedObject.FindProperty("pickupContext");
            _swapUIZone = serializedObject.FindProperty("swapUIZone");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_prefabUISlot, true);
            EditorGUILayout.PropertyField(_inventoryUISlotsContainer, true);
            ...
            if (_instanciatePickuppableOnDrop.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(_pickupContext, true);
            ...
            EditorGUILayout.Space(15);
            EditorGUILayout.PropertyField(_swapUIZone, true);
